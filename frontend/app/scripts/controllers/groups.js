...
.controller('GroupsController', function ( Rest, Storage, $scope, Auth, store  ) {
    ...
    function init(){
        ...
        Rest.Group.mygroups( { suffix1 : store.get('currentUserId') } ).$promise.then( function( mygroups ){
...
.controller('GroupMoreDetailsController', function( Rest, $filter, store, $scope, $stateParams,   Auth){
    $scope.currentGroupId = $stateParams.groupId;
